...
def compute_depth_errors(gt, pred, args):
    ...
    elif args.dataset in ['kitti','2015']:
...
class DepthEvalEigen():
    ...
    def main(self,args):
        ...
        pred_depths , errors = self.evaluate_depth(gt_depths, pred_depths, args, eval_mono=True)
    ...
    def evaluate_depth(self, gt_depths, pred_depths, args, eval_mono=True):
        ...
        for i in tqdm(range(pred_depths.shape[0])):
            if pred_depths[i].mean() != -1:
                ...
                errors.append(compute_depth_errors(val_gt_depth, val_pred_depth, args))
        ...
        return resized_pred_depths, mean_errors.tolist()

if __name__ == '__main__':
    args = parser.parse_args()
    eval = DepthEvalEigen(args)
    eval.main(args)
